...
public class TestOperations extends AbstractTestWithStaticConfiguration {
  ...
  */
  ...
  public void testAlterTable() throws Exception {
    ...
    // OFFLINE and NO_DROP were removed from tables and partitions after Hive 2.0.0 (HIVE-11145)
    //assertSemanticException(statement, "ALTER TABLE tb1 ENABLE NO_DROP cascade");
    ...
    statement.execute("set hive.metastore.disallow.incompatible.col.type.changes=false");
